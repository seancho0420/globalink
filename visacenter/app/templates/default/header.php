...
<!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>Global Link Visa Center</title>
		<meta name="description" content="Global Link Visa Center has been successfully providing visa services since 2012. We pride ourselves on personalized service, accurate and efficient visas. 
			Global Link specializes in Canada, US, UK, Schengen, China, Brazil, and Russia Visas. Please inquiry for other countries' visas. 
			Global Link Visa Center is a division of Global Link Immigration, which has been providing immigration services to clients from over the world. 
			Global Link Immigration is a Canadian Immigration firm with licensed ICCRC (Immigration Consultants of Canada Regulatory Council) consultants based in the heart of Toronto, Canada.">
		...
		<?php
			helpers\assets::css(array(
				helpers\url::template_path() . 'bootstrap/css/bootstrap.css',
				helpers\url::template_path() . 'fonts/font-awesome/css/font-awesome.css',
				helpers\url::template_path() . 'fonts/fontello/css/fontello.css',
				helpers\url::template_path() . 'plugins/magnific-popup/magnific-popup.css',
				helpers\url::template_path() . 'css/animations.css',
				helpers\url::template_path() . 'plugins/owl-carousel/owl.carousel.css',
				helpers\url::template_path() . 'css/style.css',
				helpers\url::template_path() . 'css/skins/red.css',
				helpers\url::template_path() . 'css/datepicker.css',
				helpers\url::template_path() . 'css/flag-icon.css',				
			...
			<div class="header-top">
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-offset-2 col-sm-offset-6 col-xs-10 col-sm-6">
								...
								<div class="header-top-dropdown">
									...
									<div class="btn-group dropdown">
										<ul class="social-links clear-fix">
											<li class=""><a href="http://globalinkvisacenter.com"><span class="flag-icon flag-icon-ca flag-icon-squared"></span></a></li>
											<li class=""><a href="http://cn.globalinkvisacenter.com"><span class="flag-icon flag-icon-cn flag-icon-squared"></span></a></li>
											<li class=""><a href="http://kr.globalinkvisacenter.com"><span class="flag-icon flag-icon-kr flag-icon-squared"></span></a></li>
										</ul>
									</div>
					...
					<div class="row">
						<div class="col-md-3">
							...
							<div class="header-left clearfix">
								...
								<!-- logo -->
								<div class="logo">
									<a href="<?=DIR?>"><img id="logo" src="<?=helpers\url::template_path() . 'images/glvc_logo_t.png'?>" class="img-responsive" alt="Globalink Visa Center"></a>
								</div>
										...
										<div class="container-fluid">
											...
											<div class="collapse navbar-collapse" id="navbar-collapse-1">
												<ul class="nav navbar-nav navbar-right">
													...
													<!-- mega-menu start -->
													<li class="<?=$current_page == 'visa' ? 'active' : '' ?>">
														<a href="<?=DIR?>visa">Travel Visa</a>
														<!-- <ul class="dropdown-menu">
															<li>
																<div class="row">
																		...
																		<div class="row">
																			...
																			<div class="col-sm-4">
																				...
																				<ul class="menu">
																					...
																					<li><a href="page-invoice.html"><i class="icon-right-open"></i>Invoice <span class="badge">New</span></a></li>
																				</ul>
																			</div>
																		</div>
																	</div>
													...
													<!-- mega-menu end -->
													<li class="<?=$current_page == 'passport_photo' ? 'active' : '' ?>">
														<a href="<?=DIR?>passport_photo">Passport Photo</a>
														<!-- <ul class="dropdown-menu">
															<li><a href="features-typography.html">Typography</a></li>
															<li class="dropdown">
																<a href="#" class="dropdown-toggle" data-toggle="dropdown">Email Templates <span class="default-bg badge">New</span></a>
																<ul class="dropdown-menu">
															...
															<li class="dropdown">
																<a href="#" class="dropdown-toggle" data-toggle="dropdown">Header - Options <span class="default-bg badge">New</span></a>
																<ul class="dropdown-menu">
																	...
																	<li><a href="features-header-1-dark.html">Dark - Layout 1 <span class="default-bg badge">New</span></a></li>
																	<li><a href="features-header-2-dark.html">Dark - Layout 2 <span class="default-bg badge">New</span></a></li>
																	<li><a href="features-header-3-dark.html">Dark - Layout 3 <span class="default-bg badge">New</span></a></li>
																</ul>
															</li>
