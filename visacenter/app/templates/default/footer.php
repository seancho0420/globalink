						...
						<div class="row">
							<div class="col-md-6">
								<div class="footer-content">
									<div class="logo-footer"><h2>Global Link Visa Center</h2></div>

									<ul class="social-links circle">
										<li class="facebook"><a target="_blank" href="https://www.facebook.com/glimmigration"><i class="fa fa-facebook"></i></a></li>
								...
								<div class="footer-content">
									...
									<nav>
										<ul class="nav nav-pills nav-stacked">
											...
											<li><a href="<?=DIR?>visa">Travel Visa</a></li>
											<li><a href="<?=DIR?>passport_photo">Passport Photo</a></li>
