...
<!--<![endif]-->
	<head>
		...
		<meta name="description" content="Canada Wide Pardons has successfully processed hundreds of Pardons for our clients in the last few years. We pride ourselves on personalized service, accurate and speedy Pardons. 
			Canada Wide Pardons believes in providing honest, up front advice, reasonable fees for a high level of professional and detailed service, and efficient service.
			Choose Canada Wide Pardons for your Pardon and/or US Waiver, you won't be disappointed!">
		...
		<?php
			helpers\assets::css(array(
				...
				helpers\url::template_path() . 'plugins/rs-plugin/css/settings.css',
				helpers\url::template_path() . 'plugins/rs-plugin/css/extralayers.css',
			...
			<div class="header-top">
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-6">
							<div class="header-top-first clearfix">
								<div style="margin-top:5px;font-size:18px;"><span style="color:#E70303">Call: <?=PHONE?></span></div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-3">
							...
							<div class="header-left clearfix">
								...
								<!-- logo -->
								<div class="logo">
									<a href="<?=DIR?>"><img id="logo" src="<?=helpers\url::template_path() . 'images/cwp_logo_t.png'?>" class="img-responsive" alt="Canada Wide Pardons"></a>
								</div>
										...
										<div class="container-fluid">
											...
											<div class="collapse navbar-collapse" id="navbar-collapse-1">
												<ul class="nav navbar-nav navbar-right">
													...
													<!-- mega-menu start -->
													<li class="<?=$current_page == 'pardons' ? 'active' : '' ?>">
														<a href="<?=DIR?>pardons">Pardons</a>
														<!-- <ul class="dropdown-menu">
															<li>
																<div class="row">
													...
													<!-- mega-menu end -->
													<li class="<?=$current_page == 'waivers' ? 'active' : '' ?>">
														<a href="<?=DIR?>waivers">US Waivers</a>
														<!-- <ul class="dropdown-menu">
