						...
						<div class="main col-md-12">
							<div class="row animated fadeInDownSmall">
								<div class="col-md-8">
									<!-- page-title start -->
									<!-- ================ -->
									<h1 class="page-title">Pardons</h1>
									<div class="separator-2"></div>
									<!-- page-title end -->
									<?php
								...
								<div class="col-md-4">
									...
									<form method="post">
										...
										<input type="hidden" name="look_for" value="pardon">
			...
			<div class="section gray-bg clearfix">
				<div class="container">
					<h2 class="title">A Pardon (Record Suspension) can help you in:</h2>
					<div class="separator-2"></div>

					<?php
					$i = 0;
					foreach ($data['pardon_can_help_you_in'] as $key => $value) {
						if($i % 2 == 0) {
					?>
						<div class="row">
					<?php
					...
					?>
							<div class="col-md-6">
								<p><i class="icon-check pr-10"></i> <?=$value?></p>
							</div>
					<?php
						if($i % 2 == 1 || $i + 1 == sizeof($data['pardon_can_help_you_in'])) {
					?>
						</div>
					<?php
						}
					...
					<!-- <ul class="list-icons">
						...
						foreach ($data['pardon_can_help_you_in'] as $key => $value) {
						?>
						<li><i class="icon-check pr-10"></i> <?=$value?></li>
						<?php
						}
						?>
					</ul> -->
				...
				<div class="container">
					...
					<div class="work-timeline">
						<table class="table">
							<tbody>
								<tr>
									<td>Our Work <p class="hidden-lg hidden-md"><small class="text-primary">(4-6 MONTHS)</small></p></td>
									<td>
										<div class="row">
											...
											<div class="progress-bar progress-bar-danger" style="padding-top:3px;">
												<span class="sr-only visible-lg-inline" style="right:-45px;left:auto">4 - 6</span>
												<span class="sr-only visible-md-inline" style="right:-32px;left:auto">4 - 6</span>
											</div>
											<div class="progress-bar progress-bar-danger" style="padding-top:3px;">
								...
								<tr>
									<td style="width:120px;">Gorvernment Timeline <p class="hidden-lg hidden-md"><small class="text-primary">(3-7 MONTHS)</small></p></td>
									<td>
										<div class="row">
								...
								<tr>
									<td style="width:120px;">Total Timeline <p class="hidden-lg hidden-md"><small class="text-primary">(7-13 MONTHS)</small></p></td>
									<td>
										<div class="row">
											<div class="progress-bar progress-bar-warning">
											</div>
											...
											<div class="progress-bar progress-bar-danger" style="padding-top:3px;">
												<span class="sr-only visible-lg-inline" style="right:-40px;left:auto">7 - 13</span>
												<span class="sr-only visible-md-inline" style="right:-27px;left:auto">7 - 13</span>
											</div>
											<div class="progress-bar progress-bar-danger" style="padding-top:3px;">
												<span class="sr-only visible-lg-inline visible-md-inline" style="left:4px">MONTHS</span>
											</div>
