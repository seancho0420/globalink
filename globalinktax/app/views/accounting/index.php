				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-xs-12">
							...
							<!-- page-title start -->
							<!-- ================ -->
							<h1 class="page-title">Business Plans</h1>
							<div class="separator-2"></div>
							<!-- page-title end -->
							...
							<div class="row">
								<div class="col-xs-12 animated fadeInUpSmall">
									<p>
										...
										You want to get to a point in the future (usually three to five years out) at which time your business will have a different set of resources and abilities as well as greater profitability and increased assets. 
										Your plan shows how you will get from here to there.
									</p>
									<p>
										Global Link has the business, marketing, management, and financial expertise to help you tailor a solid business plan. 
										This plan will not only keep your vision and business on track, it will help illustrate your vision and implementation plans to partners, banks, other stakeholders, regulatory bodies, etc… 
									</p>
								</div>
							</div>
						</div>
