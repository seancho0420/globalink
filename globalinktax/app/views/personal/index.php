					...
					<div class="row">
						<div class="col-md-12">
							<ol class="breadcrumb">
								...
								<li class="active"><?=$GLOBALS['glt_nav']['2']['sub']['personal']?></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-xs-12">
							...
							<!-- page-title start -->
							<!-- ================ -->
							<h1 class="page-title"><?=$data['glt_personal_tax']['title']?></h1>
							<div class="separator-2"></div>
							<!-- page-title end -->
							...
							<div class="animated fadeInUpSmall">
								<div class="row">
									<div class="col-xs-12">
										<?php foreach ($data['glt_personal_tax']['body_1'] as $key => $value) { ?>
											<p><?=$value?></p>
										<?php }?>
									</div>
								</div>
								...
								<div class="row m-t-sm">
									<div class="col-xs-12">
										<p><u><strong><?=$data['glt_personal_tax']['body_2']['title']?></strong></u></p>

										<p><?=$data['glt_personal_tax']['body_2']['content_1']?></p>

										<ul>
										<?php foreach ($data['glt_personal_tax']['body_2']['list'] as $key => $value) {
										?>
										<li><?=$value;?></li>
										<?php
										}
										...
										<p><?=$data['glt_personal_tax']['body_2']['content_2']?></p>
									</div>
								</div>
							</div>
						</div>
